...
//*******************************************************************
/* Used ESP32-DevKitC PIN Configuration:
...
| 12|  IO14|GPIO14| HSPI-CLK | ADC2-6|Status-LED| ->Green LED  |
| 13|  IO12|GPIO12| HSPI-MISO| ADC2-5| SPI1-MISO| free         |
| 14|   GND|      |          |       |       GND|              |
| 15|  IO13|GPIO13| HSPI-MOSI| ADC2-4| SPI1-MOSI| free         |
...
| 30|  IO18|GPIO18| VSPI-CLK |       | SPI0-Clk | ->ePD/SD Clk |
| 31|  IO19|GPIO19| VSPI-MISO| U0-CTS| SPI0-MISO| ->SDcard MISO|
| 32|   GND|      |          |       |      GND |              |
...
| 37|  IO23|GPIO23| VSPI-MOSI|       | SPI0-MOSI| ->ePD-Din/SD |
| 38|   GND|      |          |       |       GND|              |
*/
//*******************************************************************

//*******************************************************************
// Device configuration Matrix field
//
//*******************************************************************
...
// Default: BUSY -> 4, RST -> 16, DC -> 17, CS -> SS(5), CLK -> SCK(18), DIN -> MOSI(23), GND -> GND, 3.3V -> 3.3V
...
// Battery thresholds for LiPo 3.7V battery type
    ...
    #define BATTERY_MAX_LEVEL        4150 // V 
    #define BATTERY_MIN_LEVEL        3200 // V
    #define BATTERY_SHUTDOWN_LEVEL   3100 // V
#endif
...
#define datasetsize	5			// max. # of dynamic dataset buffer: each for "looptime" sec.
typedef struct {
